...
test('File upload with Input Tag and Type File',async({page})=>{
    ...
    await page.locator("//span[text()='Choose']/following-sibling::input").first()
        .setInputFiles("TestLeaf_PlaywrightAutomationTraining/utils/PW-W4-Alert-Frame.pdf");
...
//setFiles
await upload.setFiles("TestLeaf_PlaywrightAutomationTraining/utils/PW-W4-Alert-Frame.pdf")
